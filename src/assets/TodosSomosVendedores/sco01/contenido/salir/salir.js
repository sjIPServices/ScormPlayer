...
(lib.transicion03 = function(mode,startPosition,loop) {
...
}).prototype = getMCSymbolPrototype(lib.transicion03, new cjs.Rectangle(-632,-265,1264,650), null);
...
(lib.Símbolo9 = function(mode,startPosition,loop) {
	...
	this.shape_1.setTransform(-1.2116,-0.4685,0.8338,0.8338);
	...
	this.shape_2.setTransform(-0.1276,2.0122,0.8338,0.8338);
...
(lib.Símbolo8 = function(mode,startPosition,loop) {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#004F79").s().p("AAnDbIlWAAQhjAAhGg9QhFg8gBhVIAAgYQABhVBFg9QBGg9BjAAIFWAAIEKAAQBiAABFA9QBGA9ABBVIAAAYQgBBUhGA9QhFA9hiAAg");
	this.shape_1.setTransform(0.3381,-0.2209,0.8339,0.8339);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#00283D").s().p("AkoDZQhiAAhGg9QhFg8AAhVIAAgYQAAhVBFg9QBGg8BiAAIJQADQBjAABGA8QBGA9AABVIAAAYQAABVhGA9QhGA8hjAAg");
	this.shape_2.setTransform(1.4221,2.2599,0.8339,0.8339);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Símbolo8, new cjs.Rectangle(-44.9,-18.4,90.9,39.099999999999994), null);
...
(lib.ventana = function(mode,startPosition,loop) {
	...
	// texto copia
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#202C52").s().p("");
...
(lib.salir = function(mode,startPosition,loop) {
	...
	// transicion
	this.instance_1 = new lib.transicion03();
	this.instance_1.parent = this;
...
p.nominalBounds = new cjs.Rectangle(-779.9,215,2064.9,494.79999999999995);
// library properties:
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/fondoB01.png?1619214746267", id:"fondoB01"}
	],
	preloads: []
};
